...
exports.GammAminoConverters = void 0;
const crypto_lib_1 = require("@okxweb3/crypto-lib");
exports.GammAminoConverters = {
    "/osmosis.gamm.v1beta1.MsgJoinPool": {
        ...
        fromAmino: ({ sender, poolId, shareOutAmount, tokenInMaxs }) => {
            return {
                sender,
                poolId: crypto_lib_1.Long.fromString(poolId),
                shareOutAmount,
                tokenInMaxs: tokenInMaxs.map(el0 => ({
                    denom: el0.denom,
                    amount: el0.amount
    ...
    "/osmosis.gamm.v1beta1.MsgExitPool": {
        ...
        toAmino: ({ sender, poolId, shareInAmount, tokenOutMins }) => {
            return {
                sender,
                poolId: poolId.toString(),
                shareInAmount,
    ...
    "/osmosis.gamm.v1beta1.MsgSwapExactAmountIn": {
        ...
        fromAmino: ({ sender, routes, tokenIn, tokenOutMinAmount }) => {
            return {
                sender,
                routes: routes.map(el0 => ({
                    poolId: crypto_lib_1.Long.fromString(el0.poolId),
                    tokenOutDenom: el0.tokenOutDenom
                })),
                tokenIn: {
                    denom: tokenIn.denom,
    ...
    "/osmosis.gamm.v1beta1.MsgSwapExactAmountOut": {
        ...
        toAmino: ({ sender, routes, tokenInMaxAmount, tokenOut }) => {
            return {
                sender,
                routes: routes.map(el0 => ({
                    poolId: el0.poolId.toString(),
    ...
    "/osmosis.gamm.v1beta1.MsgJoinSwapExternAmountIn": {
        ...
        toAmino: ({ sender, poolId, tokenIn, shareOutMinAmount }) => {
            return {
                sender,
                poolId: poolId.toString(),
                tokenIn: {
    ...
    "/osmosis.gamm.v1beta1.MsgJoinSwapShareAmountOut": {
        ...
        toAmino: ({ sender, poolId, tokenInDenom, shareOutAmount, tokenInMaxAmount }) => {
            return {
                sender,
                poolId: poolId.toString(),
                tokenInDenom,
    ...
    "/osmosis.gamm.v1beta1.MsgExitSwapExternAmountOut": {
        ...
        toAmino: ({ sender, poolId, tokenOut, shareInMaxAmount }) => {
            return {
                sender,
                poolId: poolId.toString(),
                tokenOut: {
    ...
    "/osmosis.gamm.v1beta1.MsgExitSwapShareAmountIn": {
        ...
        toAmino: ({ sender, poolId, tokenOutDenom, shareInAmount, tokenOutMinAmount }) => {
            return {
                sender,
                poolId: poolId.toString(),
                tokenOutDenom,
