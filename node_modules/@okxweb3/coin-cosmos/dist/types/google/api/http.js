...
exports.Http = {
    ...
    fromJSON(object) {
        return {
            ...
            fullyDecodeReservedExpansion: (0, tx_1.isSet)(object.fullyDecodeReservedExpansion)
...
exports.HttpRule = {
    ...
    fromJSON(object) {
        return {
            selector: (0, tx_1.isSet)(object.selector) ? String(object.selector) : "",
            get: (0, tx_1.isSet)(object.get) ? String(object.get) : undefined,
            put: (0, tx_1.isSet)(object.put) ? String(object.put) : undefined,
            post: (0, tx_1.isSet)(object.post) ? String(object.post) : undefined,
            delete: (0, tx_1.isSet)(object.delete) ? String(object.delete) : undefined,
            patch: (0, tx_1.isSet)(object.patch) ? String(object.patch) : undefined,
            custom: (0, tx_1.isSet)(object.custom) ? exports.CustomHttpPattern.fromJSON(object.custom) : undefined,
            body: (0, tx_1.isSet)(object.body) ? String(object.body) : "",
            responseBody: (0, tx_1.isSet)(object.responseBody) ? String(object.responseBody) : "",
...
exports.CustomHttpPattern = {
    ...
    fromJSON(object) {
        return {
            kind: (0, tx_1.isSet)(object.kind) ? String(object.kind) : "",
            path: (0, tx_1.isSet)(object.path) ? String(object.path) : "",
        };
    },
    toJSON(message) {
        const obj = {};
