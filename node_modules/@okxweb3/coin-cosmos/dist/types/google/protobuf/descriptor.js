...
exports.FileDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: (0, tx_1.isSet)(object.name) ? String(object.name) : "",
            package: (0, tx_1.isSet)(object.package) ? String(object.package) : "",
            ...
            extension: Array.isArray(object?.extension)
                ...
                : [],
            options: (0, tx_1.isSet)(object.options) ? exports.FileOptions.fromJSON(object.options) : undefined,
            sourceCodeInfo: (0, tx_1.isSet)(object.sourceCodeInfo)
                ? exports.SourceCodeInfo.fromJSON(object.sourceCodeInfo)
                : undefined,
            syntax: (0, tx_1.isSet)(object.syntax) ? String(object.syntax) : "",
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            oneofDecl: Array.isArray(object?.oneofDecl)
                ...
                : [],
            options: (0, tx_1.isSet)(object.options) ? exports.MessageOptions.fromJSON(object.options) : undefined,
...
exports.DescriptorProto_ExtensionRange = {
    ...
    fromJSON(object) {
        return {
            start: (0, tx_1.isSet)(object.start) ? Number(object.start) : 0,
            end: (0, tx_1.isSet)(object.end) ? Number(object.end) : 0,
            options: (0, tx_1.isSet)(object.options) ? exports.ExtensionRangeOptions.fromJSON(object.options) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.FieldDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: (0, tx_1.isSet)(object.name) ? String(object.name) : "",
            number: (0, tx_1.isSet)(object.number) ? Number(object.number) : 0,
            label: (0, tx_1.isSet)(object.label) ? fieldDescriptorProto_LabelFromJSON(object.label) : 1,
            type: (0, tx_1.isSet)(object.type) ? fieldDescriptorProto_TypeFromJSON(object.type) : 1,
            typeName: (0, tx_1.isSet)(object.typeName) ? String(object.typeName) : "",
            extendee: (0, tx_1.isSet)(object.extendee) ? String(object.extendee) : "",
            defaultValue: (0, tx_1.isSet)(object.defaultValue) ? String(object.defaultValue) : "",
            oneofIndex: (0, tx_1.isSet)(object.oneofIndex) ? Number(object.oneofIndex) : 0,
            jsonName: (0, tx_1.isSet)(object.jsonName) ? String(object.jsonName) : "",
            options: (0, tx_1.isSet)(object.options) ? exports.FieldOptions.fromJSON(object.options) : undefined,
            proto3Optional: (0, tx_1.isSet)(object.proto3Optional) ? Boolean(object.proto3Optional) : false,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.OneofDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: (0, tx_1.isSet)(object.name) ? String(object.name) : "",
            options: (0, tx_1.isSet)(object.options) ? exports.OneofOptions.fromJSON(object.options) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            value: Array.isArray(object?.value)
                ...
                : [],
            options: (0, tx_1.isSet)(object.options) ? exports.EnumOptions.fromJSON(object.options) : undefined,
            reservedRange: Array.isArray(object?.reservedRange)
...
exports.EnumValueDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: (0, tx_1.isSet)(object.name) ? String(object.name) : "",
            number: (0, tx_1.isSet)(object.number) ? Number(object.number) : 0,
            options: (0, tx_1.isSet)(object.options) ? exports.EnumValueOptions.fromJSON(object.options) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            method: Array.isArray(object?.method)
                ...
                : [],
            options: (0, tx_1.isSet)(object.options) ? exports.ServiceOptions.fromJSON(object.options) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.MethodDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            name: (0, tx_1.isSet)(object.name) ? String(object.name) : "",
            inputType: (0, tx_1.isSet)(object.inputType) ? String(object.inputType) : "",
            outputType: (0, tx_1.isSet)(object.outputType) ? String(object.outputType) : "",
            options: (0, tx_1.isSet)(object.options) ? exports.MethodOptions.fromJSON(object.options) : undefined,
            clientStreaming: (0, tx_1.isSet)(object.clientStreaming) ? Boolean(object.clientStreaming) : false,
            serverStreaming: (0, tx_1.isSet)(object.serverStreaming) ? Boolean(object.serverStreaming) : false,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.FileOptions = {
    ...
    fromJSON(object) {
        return {
            javaPackage: (0, tx_1.isSet)(object.javaPackage) ? String(object.javaPackage) : "",
            javaOuterClassname: (0, tx_1.isSet)(object.javaOuterClassname) ? String(object.javaOuterClassname) : "",
            javaMultipleFiles: (0, tx_1.isSet)(object.javaMultipleFiles) ? Boolean(object.javaMultipleFiles) : false,
            javaGenerateEqualsAndHash: (0, tx_1.isSet)(object.javaGenerateEqualsAndHash)
                ? Boolean(object.javaGenerateEqualsAndHash)
                : false,
            javaStringCheckUtf8: (0, tx_1.isSet)(object.javaStringCheckUtf8) ? Boolean(object.javaStringCheckUtf8) : false,
            optimizeFor: (0, tx_1.isSet)(object.optimizeFor) ? fileOptions_OptimizeModeFromJSON(object.optimizeFor) : 1,
            goPackage: (0, tx_1.isSet)(object.goPackage) ? String(object.goPackage) : "",
            ccGenericServices: (0, tx_1.isSet)(object.ccGenericServices) ? Boolean(object.ccGenericServices) : false,
            javaGenericServices: (0, tx_1.isSet)(object.javaGenericServices) ? Boolean(object.javaGenericServices) : false,
            pyGenericServices: (0, tx_1.isSet)(object.pyGenericServices) ? Boolean(object.pyGenericServices) : false,
            phpGenericServices: (0, tx_1.isSet)(object.phpGenericServices) ? Boolean(object.phpGenericServices) : false,
            deprecated: (0, tx_1.isSet)(object.deprecated) ? Boolean(object.deprecated) : false,
            ccEnableArenas: (0, tx_1.isSet)(object.ccEnableArenas) ? Boolean(object.ccEnableArenas) : false,
            objcClassPrefix: (0, tx_1.isSet)(object.objcClassPrefix) ? String(object.objcClassPrefix) : "",
            csharpNamespace: (0, tx_1.isSet)(object.csharpNamespace) ? String(object.csharpNamespace) : "",
            swiftPrefix: (0, tx_1.isSet)(object.swiftPrefix) ? String(object.swiftPrefix) : "",
            phpClassPrefix: (0, tx_1.isSet)(object.phpClassPrefix) ? String(object.phpClassPrefix) : "",
            phpNamespace: (0, tx_1.isSet)(object.phpNamespace) ? String(object.phpNamespace) : "",
            phpMetadataNamespace: (0, tx_1.isSet)(object.phpMetadataNamespace) ? String(object.phpMetadataNamespace) : "",
            rubyPackage: (0, tx_1.isSet)(object.rubyPackage) ? String(object.rubyPackage) : "",
            uninterpretedOption: Array.isArray(object?.uninterpretedOption)
                ? object.uninterpretedOption.map((e) => exports.UninterpretedOption.fromJSON(e))
                : [],
        };
...
exports.MessageOptions = {
    ...
    fromJSON(object) {
        return {
            messageSetWireFormat: (0, tx_1.isSet)(object.messageSetWireFormat) ? Boolean(object.messageSetWireFormat) : false,
            noStandardDescriptorAccessor: (0, tx_1.isSet)(object.noStandardDescriptorAccessor)
                ? Boolean(object.noStandardDescriptorAccessor)
                : false,
            deprecated: (0, tx_1.isSet)(object.deprecated) ? Boolean(object.deprecated) : false,
            mapEntry: (0, tx_1.isSet)(object.mapEntry) ? Boolean(object.mapEntry) : false,
            uninterpretedOption: Array.isArray(object?.uninterpretedOption)
                ? object.uninterpretedOption.map((e) => exports.UninterpretedOption.fromJSON(e))
                : [],
        };
...
exports.FieldOptions = {
    ...
    fromJSON(object) {
        return {
            ctype: (0, tx_1.isSet)(object.ctype) ? fieldOptions_CTypeFromJSON(object.ctype) : 0,
            packed: (0, tx_1.isSet)(object.packed) ? Boolean(object.packed) : false,
            jstype: (0, tx_1.isSet)(object.jstype) ? fieldOptions_JSTypeFromJSON(object.jstype) : 0,
            lazy: (0, tx_1.isSet)(object.lazy) ? Boolean(object.lazy) : false,
            deprecated: (0, tx_1.isSet)(object.deprecated) ? Boolean(object.deprecated) : false,
            weak: (0, tx_1.isSet)(object.weak) ? Boolean(object.weak) : false,
            uninterpretedOption: Array.isArray(object?.uninterpretedOption)
                ? object.uninterpretedOption.map((e) => exports.UninterpretedOption.fromJSON(e))
                : [],
        };
...
exports.EnumOptions = {
    ...
    fromJSON(object) {
        return {
            allowAlias: (0, tx_1.isSet)(object.allowAlias) ? Boolean(object.allowAlias) : false,
            deprecated: (0, tx_1.isSet)(object.deprecated) ? Boolean(object.deprecated) : false,
            uninterpretedOption: Array.isArray(object?.uninterpretedOption)
                ? object.uninterpretedOption.map((e) => exports.UninterpretedOption.fromJSON(e))
                : [],
...
exports.MethodOptions = {
    ...
    fromJSON(object) {
        return {
            deprecated: (0, tx_1.isSet)(object.deprecated) ? Boolean(object.deprecated) : false,
            idempotencyLevel: (0, tx_1.isSet)(object.idempotencyLevel)
...
function createBaseUninterpretedOption() {
    return {
        name: [],
        identifierValue: "",
        positiveIntValue: crypto_lib_1.Long.UZERO,
        negativeIntValue: crypto_lib_1.Long.ZERO,
        doubleValue: 0,
    ...
    fromJSON(object) {
        return {
            name: Array.isArray(object?.name)
                ...
                : [],
            identifierValue: (0, tx_1.isSet)(object.identifierValue) ? String(object.identifierValue) : "",
            positiveIntValue: (0, tx_1.isSet)(object.positiveIntValue)
                ? crypto_lib_1.Long.fromString(object.positiveIntValue)
                : crypto_lib_1.Long.UZERO,
            negativeIntValue: (0, tx_1.isSet)(object.negativeIntValue) ? crypto_lib_1.Long.fromString(object.negativeIntValue) : crypto_lib_1.Long.ZERO,
            doubleValue: (0, tx_1.isSet)(object.doubleValue) ? Number(object.doubleValue) : 0,
            stringValue: (0, tx_1.isSet)(object.stringValue) ? bytesFromBase64(object.stringValue) : new Uint8Array(),
            aggregateValue: (0, tx_1.isSet)(object.aggregateValue) ? String(object.aggregateValue) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.positiveIntValue !== undefined &&
            (obj.positiveIntValue = (message.positiveIntValue || crypto_lib_1.Long.UZERO).toString());
        message.negativeIntValue !== undefined &&
            (obj.negativeIntValue = (message.negativeIntValue || crypto_lib_1.Long.ZERO).toString());
    ...
    fromPartial(object) {
        ...
        message.positiveIntValue =
            object.positiveIntValue !== undefined && object.positiveIntValue !== null
                ? crypto_lib_1.Long.fromValue(object.positiveIntValue)
                : crypto_lib_1.Long.UZERO;
        message.negativeIntValue =
            object.negativeIntValue !== undefined && object.negativeIntValue !== null
                ? crypto_lib_1.Long.fromValue(object.negativeIntValue)
                : crypto_lib_1.Long.ZERO;
...
exports.UninterpretedOption_NamePart = {
    ...
    fromJSON(object) {
        return {
            namePart: (0, tx_1.isSet)(object.namePart) ? String(object.namePart) : "",
            isExtension: (0, tx_1.isSet)(object.isExtension) ? Boolean(object.isExtension) : false,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.SourceCodeInfo_Location = {
    ...
    fromJSON(object) {
        return {
            ...
            leadingComments: (0, tx_1.isSet)(object.leadingComments) ? String(object.leadingComments) : "",
            trailingComments: (0, tx_1.isSet)(object.trailingComments) ? String(object.trailingComments) : "",
...
exports.GeneratedCodeInfo_Annotation = {
    ...
    fromJSON(object) {
        return {
            path: Array.isArray(object?.path) ? object.path.map((e) => Number(e)) : [],
            sourceFile: (0, tx_1.isSet)(object.sourceFile) ? String(object.sourceFile) : "",
            begin: (0, tx_1.isSet)(object.begin) ? Number(object.begin) : 0,
            end: (0, tx_1.isSet)(object.end) ? Number(object.end) : 0,
        };
    },
    toJSON(message) {
