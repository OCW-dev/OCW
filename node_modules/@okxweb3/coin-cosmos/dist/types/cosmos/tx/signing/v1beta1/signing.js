...
function createBaseSignatureDescriptor() {
    return { publicKey: undefined, data: undefined, sequence: crypto_lib_1.Long.UZERO };
}
exports.SignatureDescriptor = {
    ...
    fromJSON(object) {
        return {
            publicKey: (0, tx_1.isSet)(object.publicKey) ? any_1.Any.fromJSON(object.publicKey) : undefined,
            data: (0, tx_1.isSet)(object.data) ? exports.SignatureDescriptor_Data.fromJSON(object.data) : undefined,
            sequence: (0, tx_1.isSet)(object.sequence) ? crypto_lib_1.Long.fromString(object.sequence) : crypto_lib_1.Long.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.sequence !== undefined && (obj.sequence = (message.sequence || crypto_lib_1.Long.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseSignatureDescriptor();
        ...
        message.sequence =
            object.sequence !== undefined && object.sequence !== null
                ? crypto_lib_1.Long.fromValue(object.sequence)
...
exports.SignatureDescriptor_Data = {
    ...
    fromJSON(object) {
        return {
            single: (0, tx_1.isSet)(object.single) ? exports.SignatureDescriptor_Data_Single.fromJSON(object.single) : undefined,
            multi: (0, tx_1.isSet)(object.multi) ? exports.SignatureDescriptor_Data_Multi.fromJSON(object.multi) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.SignatureDescriptor_Data_Single = {
    ...
    fromJSON(object) {
        return {
            mode: (0, tx_1.isSet)(object.mode) ? signModeFromJSON(object.mode) : 0,
            signature: (0, tx_1.isSet)(object.signature) ? bytesFromBase64(object.signature) : new Uint8Array(),
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.SignatureDescriptor_Data_Multi = {
    ...
    fromJSON(object) {
        return {
            bitarray: (0, tx_1.isSet)(object.bitarray) ? multisig_1.CompactBitArray.fromJSON(object.bitarray) : undefined,
            signatures: Array.isArray(object?.signatures)
