...
exports.toBase64Address = exports.convertAddress = exports.validateAddress = exports.getVenomAddressBySeed = exports.parseAddress = exports.getAddressBySeed = exports.checkSeed = exports.getPubKeyBySeed = void 0;
...
function getAddressBySeed(seed) {
    checkSeed(seed);
    const { publicKey } = crypto_lib_1.signUtil.ed25519.fromSeed(crypto_lib_1.base.fromHex(seed));
