...
exports.JettonWallet = exports.VenomWallet = exports.TonWallet = void 0;
    ...
    async signTransaction(param) {
        ...
        try {
            if (data.type == "transfer") {
                return (0, transaction_1.transfer)(param.data, param.privateKey);
            }
            else if (data.type == "jettonTransfer") {
                return (0, transaction_1.jettonTransfer)(param.data, param.privateKey);
            }
        }
        catch (e) {
